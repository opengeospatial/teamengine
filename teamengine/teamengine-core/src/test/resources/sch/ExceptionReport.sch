...
<sch:schema xmlns:sch="http://www.ascc.net/xml/schematron" defaultPhase="DefaultPhase" version="1.5">
  ...
  <sch:pattern id="ExceptionReportPattern" name="ExceptionReportPattern">
    ...
    <sch:rule id="ExceptionReport" context="/">
      <sch:assert id="ExceptionReport.infoset" test="ows:ExceptionReport"
        diagnostics="includedDocElem"> The document element must have [local name] =
        "ExceptionReport" and [namespace name] = "http://www.opengis.net/ows". </sch:assert>
      <sch:assert id="ExceptionReport.version" test="ows:ExceptionReport/@version = '2.0.2'"
        diagnostics="reportedVersion"> The exception report must have @version = "2.0.2".
      </sch:assert>
    </sch:rule>
  </sch:pattern>
  ...
  <sch:pattern id="VersionNegotiationFailedPattern" name="VersionNegotiationFailedPattern">
    ...
    <sch:rule id="VersionNegotiationFailed" context="/ows:ExceptionReport">
      <sch:assert id="VersionNegotiationFailed.code"
        test="ows:Exception/@exceptionCode = 'VersionNegotiationFailed'" diagnostics="includedCode">
        The @exceptionCode attribute must have the value "VersionNegotiationFailed". </sch:assert>
    </sch:rule>
  </sch:pattern>
  ...
  <sch:pattern id="MissingParameterValuePattern" name="MissingParameterValuePattern">
    ...
    <sch:rule id="MissingParameterValue" context="/ows:ExceptionReport">
      <sch:assert id="MissingParameterValue.code"
        test="ows:Exception/@exceptionCode = 'MissingParameterValue'" diagnostics="includedCode">
        The @exceptionCode attribute must have the value "MissingParameterValue". </sch:assert>
    </sch:rule>
  </sch:pattern>
  ...
  <sch:pattern id="InvalidParameterValuePattern" name="InvalidParameterValuePattern">
    ...
    <sch:rule id="InvalidParameterValue" context="/ows:ExceptionReport">
      <sch:assert id="InvalidParameterValue.code"
        test="ows:Exception/@exceptionCode = 'InvalidParameterValue'" diagnostics="includedCode">
        The @exceptionCode attribute must have the value "InvalidParameterValue". </sch:assert>
    </sch:rule>
  </sch:pattern>
  ...
  <sch:pattern id="InvalidUpdateSequencePattern" name="InvalidUpdateSequencePattern">
    ...
    <sch:rule id="InvalidUpdateSequence" context="/ows:ExceptionReport">
      <sch:assert id="InvalidUpdateSequence.code"
        test="ows:Exception/@exceptionCode = 'InvalidUpdateSequence'" diagnostics="includedCode">
        The @exceptionCode attribute must have the value "InvalidUpdateSequence". </sch:assert>
    </sch:rule>
  </sch:pattern>
  ...
  <sch:pattern id="OperationNotSupportedPattern" name="OperationNotSupportedPattern">
    ...
    <sch:rule id="OperationNotSupported" context="/ows:ExceptionReport">
      <sch:assert id="OperationNotSupported.code"
        test="ows:Exception/@exceptionCode = 'OperationNotSupported'" diagnostics="includedCode">
        The @exceptionCode attribute must have the value "OperationNotSupported". </sch:assert>
    </sch:rule>
  </sch:pattern>
  ...
  <sch:pattern id="NoApplicableCodePattern" name="NoApplicableCodePattern">
    ...
    <sch:rule id="NoApplicableCode" context="/ows:ExceptionReport">
      <sch:assert id="NoApplicableCode.code"
        test="ows:Exception/@exceptionCode = 'NoApplicableCode'" diagnostics="includedCode"> The
        @exceptionCode attribute must have the value "NoApplicableCode". </sch:assert>
    </sch:rule>
  </sch:pattern>
  ...
  <sch:diagnostics>
    ...
    <sch:diagnostic id="includedCode"> The included exception code is: <sch:value-of
        select="ows:Exception/@exceptionCode"/>. </sch:diagnostic>
    <sch:diagnostic id="includedLocator"> The included locator is: <sch:value-of
        select="ows:Exception/@locator"/>. </sch:diagnostic>
    <sch:diagnostic id="reportedVersion"> The reported version number is <sch:value-of
        select="ows:ExceptionReport/@version"/>. </sch:diagnostic>
  </sch:diagnostics>
