...
public class CtlEarlReporterTest {
	...
	@Test
	public void testGenerateEarlReport() throws Exception {
		...
		assertThat(earlReport.toString(),
				hasXPath("//earl:TestRequirement[@rdf:about='queryable']/cite:isBasic", equalTo("false"))
					.withNamespaceContext(nsContext()));
		assertThat(earlReport.toString(),
				hasXPath("//earl:TestRequirement[@rdf:about='basic']/cite:isBasic", equalTo("true"))
					.withNamespaceContext(nsContext()));
	}
