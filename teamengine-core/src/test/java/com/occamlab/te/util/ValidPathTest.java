...
/**
 * This junit test exercises the ValidPath class ValidPath addresses security
 * vulnerabilities due to manipulation of the file system path.
 * 
...
public class ValidPathTest {
    ...
    public static void initialize() {
        ...
        if (separator.equals("\\")) {
            ...
            test3 = "c\\TE_BASE\\..\\Windows"; // Navigation up the tree is not
                                               // allowed
