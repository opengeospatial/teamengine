...
public class XMLParserUtilsTest {
	...
	public void xincludeParserNoBaseURIFixup() throws SAXException {
		...
		boolean baseURIFixup = reader
			.getFeature(Constants.XERCES_FEATURE_PREFIX + Constants.XINCLUDE_FIXUP_BASE_URIS_FEATURE);
		assertFalse("Expected feature to be false: " + Constants.XINCLUDE_FIXUP_BASE_URIS_FEATURE, baseURIFixup);
	}
	...
	class LegalNoticeHandler extends DefaultHandler {
		...
		public void startElement(String uri, String localName, String qName, Attributes attribs) throws SAXException {
			if (localName.equals("legalnotice") && (attribs.getIndex(XMLConstants.XML_NS_URI, "base") > 0)) {
