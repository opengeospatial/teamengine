...
/**
 * Support ctl:startStopwatch and ctl:elapsedTime functions 
 * so test script authors can time execution of test activities.
 * 
...
public class Stopwatch {
	...
	/**
	 * @param watchName
	 * @return elapsed time in milliseconds for a named Watch, or 0 if watchName not started
	 */
