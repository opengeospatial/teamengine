...
public class Misc {
	...
	public static Method getMethod(String className, String methodName, TEClassLoader cl, int minArgs, int maxArgs)
		...
		throw new Exception("Error: Method " + methodName + " with " + argsDesc + " was not found in class "
				+ className);
	}
	...
	// }
	// }
	// throw new Exception("Error: Method " + methodName + " with " + Integer.toString(argCount) +
	// " arguments was not found in class " + className);
	// }
