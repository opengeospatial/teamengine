		...
		try {
			...
			if (!userDir.exists()) {
				...
				message = "<html>" + "<head>" + "<meta charset=\"utf-8\">"
						...
						+ "        no-repeat 0 0;" + "    background-repeat: no-repeat;"
						+ "    background-color: black;" + "    width: 100%;" + "    height: 100px;" + "}" + "</style>"
						+ "</head>" + "<body>" + "    <div class=\"headerContainer\">"
						+ "        <img src=\"http://cite.opengeospatial.org/teamengine/site/logo.png\" />"
						+ "        <div style=\"font-size: 1.25em; margin-top: 10px;\">"
						+ "            <strong>OGC Validator</strong>" + "        </div>" + "    </div>"
						...
						+ "                                    <table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\">"
						+ "                                        <tr>"
						+ "                                            <td align=\"left\" style=\"padding: 20px 0 0 0; font-size: 16px; line-height: 25px; font-family: Helvetica, Arial, sans-serif;\">Dear &nbsp;"
						+ username + ",</td>" + "                                        </tr>"
						+ "                                        <tr>"
						...
						+ "                                        </tr>"
						+ "                                        <tr>"
						+ "                                            <td align=\"left\" style=\"padding: 20px 0 0 0; font-size: 16px;  font-family: Helvetica, Arial, sans-serif;\"><b>Verification Code :&nbsp;"
						+ vCode + "</b></td>" + "                                        </tr>"
						+ "                                        <tr>"
						...
						+ "                                        </tr>"
						+ "                                        <tr>"
						+ "                                            <td align=\"left\" style=\"padding: 20px 0 0 0; font-size: 16px; line-height: 25px; font-family: Helvetica, Arial, sans-serif;\"> <a href=\""
						+ getBaseUrl(request) + "/updatePassword.jsp"
						+ "\"> Follow this link to reset your password.</a></td>"
						+ "                                        </tr>"
						+ "                                        <tr>"
