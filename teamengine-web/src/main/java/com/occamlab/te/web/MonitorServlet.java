 ...
 * MonitorCall object. Each MonitorCall object is associated with a service endpoint.
 *
 */
...
public class MonitorServlet extends HttpServlet {
	...
	static public String allocateMonitorUrl(String url) {
		String monitorUrl = baseServletURL + "/" + servletName + "/" + monitorUrlSeq;
		monitorUrlSeq++;
	...
	static public String createMonitor(String monitorUrl, Node parserInstruction, String modifiesResponse,
			TECore core) {
	...
	static public String createMonitor(XPathContext context, String url, String localName, String namespaceURI,
			NodeInfo params, String callId, TECore core) throws Exception {
		return createMonitor(context, url, localName, namespaceURI, params, null, "", callId, core);
	}

	// Monitor that triggers a test
	static public String createMonitor(XPathContext context, String monitorUrl, String localName, String namespaceURI,
			NodeInfo params, NodeInfo parserInstruction, String modifiesResponse, String callId, TECore core)
			throws Exception {
		MonitorCall mc = monitors.get(monitorUrl);
	...
	public void process(HttpServletRequest request, HttpServletResponse response, boolean post)
		...
		try {
			...
			if (mc.getCallId() != null) {
				...
				monitorCallSeq++;
				String callId = mc.getCallId() + "_" + monitorCallSeq;
				core.callTest(mc.getContext(), mc.getLocalName(), mc.getNamespaceURI(), paramsNode.getUnderlyingNode(),
						callId);
			}
		}
		catch (Throwable t) {
