...
public class TestDriverConfig {
    ...
    /**
     * Creates a new instance of TestDriverConfig with a core set of configuration 
     * data elements.
     */
    public TestDriverConfig(String suiteName, String sessionId, List<File> ctlFiles, File logDir, boolean validate, int mode) {
     ...
     *
     * @return  a File object representing the location of the test session directory.
     */
    ...
    /**
     * 
     * @param webApp  indicates the presence a web application context.
     */
