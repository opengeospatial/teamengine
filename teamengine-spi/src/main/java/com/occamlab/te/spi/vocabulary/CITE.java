...
public class CITE {
    ...
    /**
     * A TestNG test parameter (test/parameter) that indicates the optionality
     * of a conformance class in a conformity assessment. At least one is
     * usually deemed to be mandatory.
     */
    ...
    public static final Property testsBestPractice = model
    ...
    /**
     * Property of a conformance class (earl:TestRequirement). The following
     * values indicate its significance with respect to a conformity assessment:
     * <ul>
     * <li>mandatory</li>
     * <li>recommended</li>
