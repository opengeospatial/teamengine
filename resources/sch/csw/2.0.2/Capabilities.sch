...
<sch:schema xmlns:sch="http://www.ascc.net/xml/schematron" 
  ...
  <sch:pattern id="CapabilitiesPattern" name="CapabilitiesPattern">
	...
	The document element must have [local name] = "Capabilities" and [namespace name] = "http://www.opengis.net/cat/csw/2.0.2".
      </sch:assert>
      <sch:assert id="docElement.version" 
        test="csw:Capabilities/@version='2.0.2'">
	The @version attribute must have the value "2.0.2".
      </sch:assert>
    </sch:rule>
  </sch:pattern>
  ...
  <sch:pattern id="RequiredParametersPattern" name="RequiredParametersPattern">
    <sch:p xml:lang="en">
    Checks that all required CSW operational parameters are present.
    </sch:p>
	...
	Missing mandatory version parameter, "2.0.2".
      </sch:assert>    
   </sch:rule>
   <sch:rule id="RequiredGetCapabilitiesParameters" context="//ows:OperationsMetadata/ows:Operation[@name='GetCapabilities']">
	...
	Missing mandatory sections parameter for GetCapabilities, "ServiceIdentification".
      </sch:assert>
	...
	Missing mandatory sections parameter for GetCapabilities, "ServiceProvider".
      </sch:assert>
	...
	Missing mandatory sections parameter for GetCapabilities, "OperationsMetadata".
      </sch:assert>   
   ...
   <sch:rule id="RequiredDescribeRecordParameters" context="//ows:OperationsMetadata/ows:Operation[@name='DescribeRecord']">   
	...
	Missing mandatory TypeName parameter for DescribeRecord, "csw:Record".
      </sch:assert>
	...
	Missing mandatory outputFormat parameter for DescribeRecord, "application/xml".
      </sch:assert>
	...
	Missing mandatory schemaLanguage parameter for DescribeRecord, "http://www.w3.org/TR/xmlschema-1/".
      </sch:assert>       
   </sch:rule>
   <sch:rule id="RequiredGetRecordsParameters" context="//ows:OperationsMetadata/ows:Operation[@name='GetRecords']">
	...
	Missing mandatory typeNames parameter for GetRecords, "csw:Record".
      </sch:assert>   
	...
	Missing mandatory outputSchema parameter for GetRecords, "http://www.opengis.net/cat/csw/2.0.2".
      </sch:assert>
      <sch:assert id="GetRecordsOutputFormat" 
        test="ows:Parameter[translate(@name,'ABCDEFGHIJKLMNOPQRSTUVWXYZ','abcdefghijklmnopqrstuvwxyz')='outputformat']/ows:Value = 'application/xml'">
	Missing mandatory outputFormat parameter for GetRecords, "application/xml".
      </sch:assert>   
	...
	Missing mandatory resultType parameter for GetRecords, "hits".
      </sch:assert>
	...
	Missing mandatory resultType parameter for GetRecords, "results".
      </sch:assert>
	...
	Missing mandatory resultType parameter for GetRecords, "validate".
      </sch:assert>            
   </sch:rule>
   <sch:rule id="RequiredGetRecordByIdParameters" context="//ows:OperationsMetadata/ows:Operation[@name='GetRecordById']">
      <sch:assert id="GetRecordByIdOutputSchema" 
        test="ows:Parameter[translate(@name,'ABCDEFGHIJKLMNOPQRSTUVWXYZ','abcdefghijklmnopqrstuvwxyz')='outputschema']/ows:Value = 'http://www.opengis.net/cat/csw/2.0.2'">
	Missing mandatory outputSchema parameter for GetRecordById, "http://www.opengis.net/cat/csw/2.0.2".
      </sch:assert>
      <sch:assert id="GetRecordByIdOutputFormat" 
        test="ows:Parameter[translate(@name,'ABCDEFGHIJKLMNOPQRSTUVWXYZ','abcdefghijklmnopqrstuvwxyz')='outputformat']/ows:Value = 'application/xml'">
	Missing mandatory outputFormat parameter for GetRecordById, "application/xml".
      </sch:assert>       
	...
	Missing mandatory ElementSetName parameter for GetRecordById, "brief".
      </sch:assert>
	...
	Missing mandatory ElementSetName parameter for GetRecordById, "summary".
      </sch:assert>
	...
	Missing mandatory ElementSetName parameter for GetRecordById, "full".
      </sch:assert>            
   </sch:rule>
  </sch:pattern>  
