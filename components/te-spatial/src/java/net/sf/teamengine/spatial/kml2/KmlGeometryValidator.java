 ...
 * See <a target="_blank"
 * href="http://portal.opengeospatial.org/files/?artifact_id=18241"> OGC
 * 06-103r3</a> or the <a target="_blank"
 * href="http://www.vividsolutions.com/jts/javadoc/index.html"> JTS API
 * documentation</a> for a general description of these.
 */
public class KmlGeometryValidator {
	...
	public KmlGeometryValidator() {
		...
		validationMessages = new Hashtable<String, String>();
	}
	 ...
	 *            {@link #getMessage(String) getMessage} method).
